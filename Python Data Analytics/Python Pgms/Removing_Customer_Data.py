...
# Add a new column '1_column' after 'TotalCharges' and set all values to 0
customers_df.insert(loc=customers_df.columns.get_loc('TotalCharges') + 1, column='1_column', value=0)

# Save the DataFrame to a CSV file with the new name
customers_df.to_csv('remove_customers.csv', index=False)

print("remove_customers.csv file created with 3827 rows of sample data, including hash codes for CustomerID and a new field 'column_1' set to 0.")
